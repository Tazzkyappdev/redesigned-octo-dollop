...
export const Hero = () => {
  ...
  const calculateEarnings = () => {
    ...
    const adjustedPrice = basePrice * locationMultiplier * demandMultiplier * volumeDiscount * seasonalFactor * travelFactor * equipmentFactor
    ...
    <section id="hero" className="py-8 md:py-16 lg:py-20 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.h1
              className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] mb-4 leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.5 }}
            >
              Convierte tu talento en{' '}
              <span className="text-[#BADB3A]">ingresos constantes</span>
            </motion.h1>
            ...
            >
              Consigue clientes reales sin publicaciones, sin comisiones abusivas y sin perder tiempo.
            </motion.p>
